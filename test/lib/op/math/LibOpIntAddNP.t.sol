...
contract LibOpIntAddNPTest is OpTest {
    ...
    function testOpIntAddNPEval2InputsHappyZeroMax() external {
        checkHappy("_: int-add(0 max-integer-value());", type(uint256).max, "0 + max-integer-value()");
        checkHappy("_: int-add(max-integer-value() 0);", type(uint256).max, "max-integer-value() + 0");
    }
    ...
    function testOpDecimal18AddNPEval2InputsHappyZeroMax() external {
        checkHappy("_: decimal18-add(0 max-integer-value());", type(uint256).max, "0 + max-integer-value()");
        checkHappy("_: decimal18-add(max-integer-value() 0);", type(uint256).max, "max-integer-value() + 0");
    }
