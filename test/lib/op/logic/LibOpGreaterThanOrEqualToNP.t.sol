...
contract LibOpGreaterThanOrEqualToNPTest is OpTest {
    ...
    function testOpGreaterThanOrEqualToNPRun(InterpreterStateNP memory state, uint256 input1, uint256 input2)
        external
    {
    ...
    function testOpGreaterThanOrEqualToNPEvalFail0Inputs() public {
        (bytes memory bytecode, uint256[] memory constants) = iDeployer.parse("_: greater-than-or-equal-to();");
        uint256[] memory minOutputs = new uint256[](1);
        minOutputs[0] = 1;
    ...
    function testOpGreaterThanOrEqualToNPEvalFail1Input() public {
        (bytes memory bytecode, uint256[] memory constants) = iDeployer.parse("_: greater-than-or-equal-to(0x00);");
        uint256[] memory minOutputs = new uint256[](1);
        minOutputs[0] = 1;
    ...
    function testOpGreaterThanOrEqualToNPEvalFail3Inputs() public {
        (bytes memory bytecode, uint256[] memory constants) =
            iDeployer.parse("_: greater-than-or-equal-to(0x00 0x00 0x00);");
        uint256[] memory minOutputs = new uint256[](1);
        minOutputs[0] = 1;
