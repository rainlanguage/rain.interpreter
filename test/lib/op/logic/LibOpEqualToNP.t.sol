...
contract LibOpEqualToNPTest is OpTest {
    ...
    function testOpEqualToNPRun(InterpreterStateNP memory state, uint256 seed, uint256 input1, uint256 input2)
        external
    {
        ...
        opReferenceCheck(
            state, seed, operand, LibOpEqualToNP.referenceFn, LibOpEqualToNP.integrity, LibOpEqualToNP.run, inputs
        );
    }
