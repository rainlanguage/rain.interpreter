...
contract LibParseSingleRHSNamedGasTest is Test {
    ...
    function testParseGasRHS00() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:a();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS01() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS02() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS03() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaaa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS04() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaaaa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS05() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaaaaa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS06() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaaaaaa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS07() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaaaaaaa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS08() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaaaaaaaa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS09() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaaaaaaaaa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS10() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaaaaaaaaaa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS11() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaaaaaaaaaaa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS12() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaaaaaaaaaaaa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS13() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaaaaaaaaaaaaa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS14() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaaaaaaaaaaaaaa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS15() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaaaaaaaaaaaaaaa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS16() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaaaaaaaaaaaaaaaa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS17() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaaaaaaaaaaaaaaaaa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS18() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaaaaaaaaaaaaaaaaaa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS19() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaaaaaaaaaaaaaaaaaaa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS20() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaaaaaaaaaaaaaaaaaaaa();"), meta);
        (bytecode);
        (constants);
    }
    ...
    function testParseGasRHS21() external view {
        (bytes memory bytecode, uint256[] memory constants) = LibParse.parse(bytes("_:aaaaaaaaaaaaaaaaaaaaaa();"), meta);
        (bytecode);
        (constants);
    }
