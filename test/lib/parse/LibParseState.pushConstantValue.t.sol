...
contract LibParseStatePushConstantValueTest is Test {
    ...
    function testPushConstantValueEmpty(bytes memory data, bytes memory meta, uint256 literalParsers) external {
        // Start with a fresh state.
        ParseState memory state = LibParseState.newState(data, meta, literalParsers);
