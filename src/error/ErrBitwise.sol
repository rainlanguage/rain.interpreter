...
/// @notice Thrown during integrity check when a bitwise shift operation is attempted
...
/// @notice Thrown during integrity check when bitwise (en|de)coding would be truncated
