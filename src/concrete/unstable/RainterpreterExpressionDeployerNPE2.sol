...
bytes constant INTEGRITY_FUNCTION_POINTERS_E2 =
...
bytes32 constant STORE_BYTECODE_HASH_E2 = bytes32(0xd6130168250d3957ae34f8026c2bdbd7e21d35bb202e8540a9b3abcbc232ddb6);

/// @dev Hash of the known authoring meta.
bytes32 constant AUTHORING_META_HASH_E2 = bytes32(0xb16774f25e8070712c15ff6f551827d0c112a45d880c2aa8b63b1c2f89a13f7b);
...
/// Rainlang strings.
contract RainterpreterExpressionDeployerNPE2 is IExpressionDeployerV3, IParserV1, ERC165 {
    ...
    function expectedConstructionMetaHash() internal pure virtual returns (bytes32) {
        return CONSTRUCTION_META_HASH_E2;
    }
    ...
    function expectedInterpreterFunctionPointersHash() internal pure virtual returns (bytes32) {
        return OPCODE_FUNCTION_POINTERS_HASH_E2;
    }
    ...
    function expectedInterpreterBytecodeHash() internal pure virtual returns (bytes32) {
        return INTERPRETER_BYTECODE_HASH_E2;
    }
