...
uint128 constant CMASK_LOWER_ALPHA_A_F = CMASK_LOWER_A | CMASK_LOWER_B | CMASK_LOWER_C | CMASK_LOWER_D | CMASK_LOWER_E
    | CMASK_LOWER_F;

/// @dev upper alpha A-F (hex)
uint128 constant CMASK_UPPER_ALPHA_A_F = CMASK_UPPER_A | CMASK_UPPER_B | CMASK_UPPER_C | CMASK_UPPER_D | CMASK_UPPER_E
    | CMASK_UPPER_F;
