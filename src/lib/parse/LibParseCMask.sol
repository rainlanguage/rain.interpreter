...
uint128 constant CMASK_PRINTABLE = ~(CMASK_NULL | CMASK_START_OF_HEADING | CMASK_START_OF_TEXT | CMASK_END_OF_TEXT
    | CMASK_END_OF_TRANSMISSION | CMASK_ENQUIRY | CMASK_ACKNOWLEDGE | CMASK_BELL | CMASK_BACKSPACE | CMASK_HORIZONTAL_TAB
    | CMASK_LINE_FEED | CMASK_VERTICAL_TAB | CMASK_FORM_FEED | CMASK_CARRIAGE_RETURN | CMASK_SHIFT_OUT | CMASK_SHIFT_IN
...
/// @dev Rainlang string tail is any printable ASCII except "
uint128 constant CMASK_STRING_LITERAL_TAIL = ~CMASK_QUOTATION_MARK & CMASK_PRINTABLE;
