...
/// @title LibOpFloor
/// @notice Opcode for the floor of a decimal floating point number.
library LibOpFloor {
    using LibDecimalFloat for Float;

    /// @notice `floor` integrity check. Requires exactly 1 input and produces 1 output.
    ...
    /// @notice Gas intensive reference implementation of floor for testing.
