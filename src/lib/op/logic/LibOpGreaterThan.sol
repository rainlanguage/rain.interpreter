...
library LibOpGreaterThan {
    ...
    /// @notice `greater-than` integrity check. Requires exactly 2 inputs and produces 1 output.
    ...
    /// @notice Gas intensive reference implementation of GT for testing.
