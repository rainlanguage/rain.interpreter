...
library LibOpUint256ERC20BalanceOf {
    ...
    /// `uint256-erc20-balance-of` opcode. Calls `balanceOf` on the token and returns the raw uint256 balance.
    ...
    /// Reference implementation of `uint256-erc20-balance-of` for testing.
